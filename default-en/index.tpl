...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        ...
        <div class="row center">
            <h5 class="header col s12 light">Easy science online, Protect personal privacy</h5>
            {$homeIndexMsg}
        </div>
        {if $user->isLogin}
            <div class="row center">
                <a href="/user" id="download-button" class="btn-large waves-effect waves-light orange">User Center</a>
            </div>
        {else}
        <div class="row center">
