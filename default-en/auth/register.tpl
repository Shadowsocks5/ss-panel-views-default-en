...
<div class="register-box">
    ...
    <div class="register-box-body">
        <p class="login-box-msg">Registered</p>
        ...
        {if $requireEmailVerification}
            <div class="form-group">
                ...
                <span class="input-group-btn">
                    <button type="button" id="sendcode" class="btn btn-default btn-flat">Send</button>
                </span>
                </div>
            </div>
        {/if}
        ...
        <div class="form-group has-feedback">
            <input type="password" id="repasswd" class="form-control" placeholder="Continue"/>
        ...
        <div class="form-group has-feedback">
            <p>Agree<a href="/tos">Terms of Service</a></p>
        </div>

        <div class="form-group has-feedback">
            <button type="submit" id="reg" class="btn btn-primary btn-block btn-flat">Agree to the terms of service and submit the registration</button>
        </div>

        <div id="msg-success" class="alert alert-info alert-dismissable" style="display: none;">
            <button type="button" class="close" id="ok-close" aria-hidden="true">&times;</button>
            <h4><i class="icon fa fa-info"></i>Successful</h4>
            <p id="msg-success-p"></p>
        </div>

        <div id="msg-error" class="alert alert-warning alert-dismissable" style="display: none;">
            <button type="button" class="close" id="error-close" aria-hidden="true">&times;</button>
            <h4><i class="icon fa fa-warning"></i>Error, Please contact the administrator.</h4>
            <p id="msg-error-p"></p>
        </div>
    ...
    $(document).ready(function () {
        ...
        $("#sendcode").on("click", function () {
            ...
            if (!email) {
                $("#msg-error").hide(10);
                $("#msg-error").show(100);
                $("#msg-error-p").html("Please enter your email");
                return $("#email").focus();
            }
